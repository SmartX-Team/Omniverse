            ...
            actions=[
                Node(
                    ...
                    parameters=[{
                        ...
                        'depth_module.depth_profile': '640x480x30',  # Jazzy realsense-ros 4.5x 개명 반영
                        'rgb_camera.color_profile': '640x480x30',
                    }],
                    # 리매핑 키 수정 (1.1): realsense-ros 4.5x는 camera_namespace/노드명
                    # 아래(/camera/realsense_camera/...)로 발행 — 옛 키는 매칭 안 돼 무효였음
                    remappings=[
                        ('/camera/realsense_camera/depth/color/points', camera_points_topic),
                        ('/camera/realsense_camera/depth/image_rect_raw', '/camera/depth/image'),
                        ('/camera/realsense_camera/color/image_raw', '/camera/color/image'),
                    ],
